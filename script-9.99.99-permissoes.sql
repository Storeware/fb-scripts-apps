...
GRANT SELECT ON FILIAL TO PUBLICWEB;


grant execute on procedure MD_SIG02_RANK_CLIENTE to wba;
GRANT EXECUTE ON PROCEDURE PROC_INFO_CAST TO WBA;
GRANT EXECUTE ON PROCEDURE PROC_TOP5_DIAS_VDAS TO WBA;